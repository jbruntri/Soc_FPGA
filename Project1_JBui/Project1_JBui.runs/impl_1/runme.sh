...
HD_PWD='C:/Users/jbu021/Soc_FPGA/Project1_JBui/Project1_JBui.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopwatch_test.tcl -notrace
