...
HD_PWD='C:/Users/jbu021/Soc_FPGA/Project1_JBui/Project1_JBui.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_test.tcl
