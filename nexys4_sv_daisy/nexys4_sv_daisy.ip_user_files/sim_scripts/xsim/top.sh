...
xvlog_opts="-m64 --relax -L xil_defaultlib"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L microblaze_v10_0_3 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_11 -L lmb_v10_v3_0_9 -L lmb_bram_if_cntlr_v4_0_12 -L blk_mem_gen_v8_3_6 -L iomodule_v3_1_1 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot  xil_defaultlib. xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim  -key {Behavioral:sim_1:Functional:} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(microblaze_v10_0_3 lib_cdc_v1_0_2 proc_sys_reset_v5_0_11 lmb_v10_v3_0_9 lmb_bram_if_cntlr_v4_0_12 blk_mem_gen_v8_3_6 iomodule_v3_1_1)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb .wdb xsim.dir)
