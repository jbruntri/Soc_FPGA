...
HD_PWD='C:/Users/jbu021/Documents/Learning/microphone/microphone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mic_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mic_test.tcl
