...
HD_PWD='C:/Users/jbu021/Documents/Learning/microphone/microphone.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mic_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mic_test.tcl -notrace
